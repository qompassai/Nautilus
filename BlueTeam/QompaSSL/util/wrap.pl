...
BEGIN {
    ...
    require '/home/phaedrus/Forge/GH/Qompass/Nautilus/BlueTeam/QompaSSL/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/phaedrus/Forge/GH/Qompass/Nautilus/BlueTeam/QompaSSL/test/fips-and-base.cnf';
    shift;
